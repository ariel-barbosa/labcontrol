...
SECRET_KEY = 'django-insecure-=(%&-)3cmzm7!mzdb=l80mw%_1n-6+v2rj07hcyf_idtt#fbov'
...
INSTALLED_APPS = [
    ...
    'labs.apps.LabsConfig',  # Deve estar declarado desta forma
    'crispy_forms',
    'crispy_bootstrap5',
    'widget_tweaks',
]

# AUTH_USER_MODEL = 'labs.CustomUser'
